package uz.context.jetpackpagination.screens.commons
...
import uz.context.jetpackpagination.model.Urls
import uz.context.jetpackpagination.model.User
import uz.context.jetpackpagination.model.UserLinks
import uz.context.jetpackpagination.navigation.Screen
import uz.context.jetpackpagination.ui.theme.HeartRed
...
fun UnsplashItem(unsplashImage: UnsplashImage, onItemClicked: (id: String) -> Unit) {
    ...
    Box(
        modifier = Modifier
            .clickable {
                onItemClicked(unsplashImage.id)
            }
            .height(300.dp)
            .fillMaxWidth(),
