package uz.context.jetpackpagination.paging
...
class UnsplashRemoteMediator (
    ...
    private val imageDao = unsplashDatabase.unsplashImageDao()
    private val remoteKeysDao = unsplashDatabase.unsplashRemoteKeysDao()
